...
{
    public abstract class FieldTask : Task
    {
        /// <summary>
        ...
        /// <summary>
        /// Return true if the task should work on tiles with crops in them, or false if it should work on tiles without crops in them
        /// </summary>
        /// <returns></returns>
        protected abstract bool WorkTilesWithCrop();

        /// <summary>
        /// Determine how many tiles of the field the worker can handel on each trip
        /// </summary>
        protected abstract int DetermineMaxTilesPerTrip(int workerNum, TaskItemPlanner itemPlanner, TaskEquipmentPlanner equipmentPlanner);
        
        /// <summary>
        /// Called before any trips are planned.  Allows derived classes to plan what to do before any trip is made, or check for issues.
        /// </summary>
        protected virtual void PlanBeforeTrips(TaskPlan plan, TaskItemPlanner itemPlanner, TaskEquipmentPlanner equipmentPlanner) { }

        /// <summary>
        /// Plan one trip to the field for one worker
        /// </summary>
        protected abstract void PlanTrip(TaskPlan plan, int workerNum, List<Land> tripLand, TaskItemPlanner itemPlanner, TaskEquipmentPlanner equipmentPlanner);
