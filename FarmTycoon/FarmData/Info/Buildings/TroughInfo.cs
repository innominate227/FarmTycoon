...
{
    public class TroughInfo : IPloppableInfo, IInventoryInfo, IInfo, ITexturesInfo, IStorageBuildingInfo
    {
        /// <summary>
        /// Prepended to the unique name of all TroughInfo
        /// </summary>
        public const string UNIQUE_PREPEND = "Trough_";
        ...
        public TroughInfo(XmlReader reader, FarmData farmInfo)
        {
            reader.ReadToFollowing("Trough");
