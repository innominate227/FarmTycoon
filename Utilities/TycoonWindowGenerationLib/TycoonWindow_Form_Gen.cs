...
{
    public partial class TycoonWindow_Form_Gen : Form
    {
        public TycoonWindow_Form_Gen()
        {
            InitializeComponent();
        ...
        private Font _titleFont = new Font("Segoe UI", 8, FontStyle.Regular);
        private StringAlignment _titleAlign = StringAlignment.Near;
        private Color _titleBarColor = Color.FromArgb(96, 32, 0);
